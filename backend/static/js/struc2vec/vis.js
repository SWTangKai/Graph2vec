...
function testForceGraph(dataset_name, dom) {
...
function render(graph, domName) {
  const width = document.querySelector(domName).offsetWidth;
  const height = document.querySelector(domName).offsetHeight;
